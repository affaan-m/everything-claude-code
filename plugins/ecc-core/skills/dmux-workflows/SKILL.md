...
```bash
node skills/dmux-workflows/scripts/orchestrate-worktrees.js plan.json --execute
```
...
```json
{
  ...
  "seedPaths": [
    "skills/dmux-workflows/scripts/orchestrate-worktrees.js",
    "skills/dmux-workflows/scripts/tmux-worktree-orchestrator.js",
