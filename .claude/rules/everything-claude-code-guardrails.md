...
- add-new-skill: Adds a new skill to the codebase, including documentation, agent configuration, and cross-harness copies.
- add-new-agent: Adds a new agent to the codebase, including documentation and registration.
