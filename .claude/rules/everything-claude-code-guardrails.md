...
- add-new-skill: Adds a new skill to the codebase, including documentation and harness support.
- add-new-agent: Adds a new agent to the system, including registration and documentation updates.
