...
- add-new-skill: Adds a new skill to the codebase, including documentation and review fixes.
- add-new-agent: Registers a new agent, including documentation and catalog updates.
