...
- add-new-agent-definitions: Adds one or more new agent definitions, typically for specialized workflows or pipelines, by creating new agent markdown files with frontmatter and routing/model/tool configuration.
