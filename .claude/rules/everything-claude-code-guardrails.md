...
- add-team-or-identity-or-research-config: Adds a new team, identity, or research configuration to the system.
- add-command-or-skill-or-agent-or-workflow: Adds a new command, skill, agent, or workflow to the system.
