...
- add-new-agent-command: Adds a new agent command to the system, documenting how to add new agents.
- add-new-skill-command: Adds a new skill command to the system, documenting how to add new skills.
