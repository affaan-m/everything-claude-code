...
- add-documentation-command-or-skill-or-agent-or-workflow: Adds documentation for a new command, skill, agent, or workflow to the project.
- add-team-or-identity-or-research-config: Adds or updates configuration files for team, identity, or research settings.
