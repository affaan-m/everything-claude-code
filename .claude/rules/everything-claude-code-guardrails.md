...
- add-new-agent-command: Adds a new agent command to the system, documenting the process in the ECC bundle.
- add-new-skill-command: Adds a new skill command to the system, documenting the process in the ECC bundle.
