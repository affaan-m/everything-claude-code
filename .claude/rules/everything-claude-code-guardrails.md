...
- add-new-skill: Adds a new skill to the project, including documentation and registration.
- harden-or-update-skill: Improves, clarifies, or fixes an existing skill, often for bugfixes, documentation, or robustness.
