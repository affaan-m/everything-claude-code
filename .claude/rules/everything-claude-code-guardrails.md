...
- add-new-agent-command: Adds documentation for the workflow to add a new agent to the system.
- add-new-skill-command: Adds documentation for the workflow to add a new skill to the system.
