...
- Prefer `conventional` commit messaging with prefixes such as fix, feat, docs.
...
- add-or-update-skill: Adds a new skill or updates an existing skill, including documentation and sometimes tests.
- add-or-update-command: Adds or updates a command for the system, often with documentation and sometimes with implementation scripts.
