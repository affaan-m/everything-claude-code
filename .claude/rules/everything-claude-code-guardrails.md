...
- add-new-skill-command: Adds a new skill command to the ECC bundle, documenting how to add a new skill.
- add-new-agent-command: Adds a new agent command to the ECC bundle, documenting how to add a new agent.
