...
- add-new-skill: Adds a new skill to the codebase, including documentation and implementation files.
- harden-or-fix-skill-or-hook: Improves robustness, fixes bugs, or clarifies documentation for an existing skill or hook, often with tests.
