...
- add-command-or-skill-or-agent-or-workflow: Adds a new documentation command, skill, agent, or workflow to the ECC bundle.
- add-team-or-identity-or-research-config: Adds or updates team, identity, or research configuration files for the ECC bundle.
