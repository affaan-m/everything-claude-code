...
Adds a new skill command to the system, documenting how to add new skills.
...
- Create or update '.claude/commands/add-new-skill-command.md' with instructions or definitions.
- Commit the file.
