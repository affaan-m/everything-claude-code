...
Adds agent configuration files for a new ECC bundle across multiple agent directories.
...
- Create or update .agents/skills/everything-claude-code/agents/openai.yaml
