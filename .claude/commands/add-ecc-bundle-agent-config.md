...
Adds agent configuration files for ECC bundle by creating .toml or .yaml files in agent config directories.
...
- Create .agents/skills/everything-claude-code/agents/openai.yaml
