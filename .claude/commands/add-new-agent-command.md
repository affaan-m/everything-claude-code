...
Adds documentation for the workflow to add a new agent to the system.
...
- Create or update .claude/commands/add-new-agent.md with instructions or templates for adding a new agent.
