...
Adds skill documentation files for a new ECC bundle to both .claude and .agents directories.
...
- Create .claude/skills/{bundle-name}/SKILL.md
- Create .agents/skills/{bundle-name}/SKILL.md
