...
Adds a new component to the everything-claude-code-conventions ECC bundle, such as skills, agent skills, identity, or commands.
...
- Create or update a file in one of the ECC bundle directories (e.g., .claude/skills/everything-claude-code/, .agents/skills/everything-claude-code/, .claude/commands/, .claude/identity.json, .claude/ecc-tools.json)
