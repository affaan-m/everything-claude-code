...
- Create or update a file under a specific ECC bundle directory (e.g., .claude/skills/everything-claude-code/, .agents/skills/everything-claude-code/, .claude/commands/)
