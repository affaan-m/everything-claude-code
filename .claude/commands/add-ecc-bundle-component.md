...
Adds a new component to the everything-claude-code-conventions ECC bundle, such as a skill, agent, identity, or command.
...
- Create or update a file under a specific ECC-related directory (e.g., .claude/skills, .agents/skills, .claude/commands, .claude/identity.json, .codex/agents).
