...
Adds a new component (such as skill, agent, or configuration) to the everything-claude-code ECC bundle.
...
- Create or update a file under .claude/, .agents/, or .codex/ related to the new component.
