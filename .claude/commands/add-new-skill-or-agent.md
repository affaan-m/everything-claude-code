...
- Create or update SKILL.md file in skills/ or .agents/skills/ or .claude/skills/
- Add or update agent definition in agents/ or .agents/agents/
- Update manifests/install-modules.json if needed
- Update AGENTS.md and/or README.md to document the new skill/agent
- Add or update related documentation in docs/ or examples/
