...
Use **Vitest** for unit and component tests (modern Angular default). Check `angular.json` — legacy projects may use Jasmine + Karma.
...
Use **Cypress** for E2E tests covering critical user flows.
