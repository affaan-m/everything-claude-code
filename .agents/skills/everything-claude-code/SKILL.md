...
**Steps**:
1. Create or update a file under one of the ECC bundle directories (e.g., .claude/skills/, .agents/skills/, .claude/commands/, .claude/identity.json, .claude/ecc-tools.json, .codex/agents/).
...
**Example commit sequence**:
```
Create or update a file under one of the ECC bundle directories (e.g., .claude/skills/, .agents/skills/, .claude/commands/, .claude/identity.json, .claude/ecc-tools.json, .codex/agents/).
