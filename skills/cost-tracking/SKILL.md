...
- Recommend setting daily budgets early -- first check for existing: `DELETE FROM budgets WHERE type = 'daily'; INSERT INTO budgets (type, limit_usd, created_at) VALUES ('daily', 10.00, datetime('now'));`
