---
name: api-backend
description: REST API design patterns, backend architecture, database optimization, caching strategies, and server-side best practices for production APIs.
origin: ECC
---

# API & Backend Patterns

Conventions and best practices for designing REST APIs and building scalable backend architectures.

## When to Activate

- Designing new API endpoints or reviewing existing API contracts
- Implementing repository, service, or controller layers
- Adding pagination, filtering, or sorting
- Implementing error handling and validation for APIs
...
- [ ] Correct HTTP methods and status codes used semantically
...
- [ ] Structured logging in place with request correlation IDs
