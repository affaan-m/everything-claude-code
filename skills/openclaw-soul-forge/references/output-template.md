...
2. **Generate SOUL.md**: extract the full "Soul" section and the full "Intensity Calibration" section from the blueprint
3. **Generate IDENTITY.md**: extract the full "Identity Card" section and include the avatar path when one exists
