...
Adam, the lobster deity and first creation of this Skill, defines the visual baseline.
All newly generated lobster avatars should maintain visual consistency with that baseline.
...
2. Call the approved image-generation skill to generate the image
...
### Path B: no approved image-generation skill is installed
