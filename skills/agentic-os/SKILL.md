...
- @dev tasks: claude-opus-4-7 for complex architecture
- @researcher tasks: claude-sonnet-4-6 with web-search enabled
- Cost ceiling: warn user before exceeding $5 in a single session
```
