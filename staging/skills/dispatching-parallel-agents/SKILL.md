...
1. Multiple failures? If no -> single agent investigates all
2. Are they independent? If no (related) -> single agent investigates all
3. Can they work in parallel? If yes -> parallel dispatch. If no (shared state) -> sequential agents
