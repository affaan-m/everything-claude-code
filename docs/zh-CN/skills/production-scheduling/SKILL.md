...
description: 针对离散和批量制造中的生产排程、作业排序、生产线平衡、换型优化和瓶颈解决的编码化专业知识。由拥有15年以上经验的生产排程人员提供。包括约束理论/鼓-缓冲-绳法、SMED、OEE分析、中断响应框架以及ERP/MES交互模式。适用于生产排程、解决瓶颈、优化换型、应对中断或平衡生产线时使用。license: Apache-2.0
version: 1.0.0
