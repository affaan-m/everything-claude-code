...
description: 针对退货授权、收货与检查、处置决策、退款处理、欺诈检测及保修索赔管理的编码化专业知识。由拥有15年以上经验的退货运营经理提供指导。包含分级框架、处置经济学、欺诈模式识别及供应商回收流程。适用于处理产品退货、逆向物流、退款决策、退货欺诈检测或保修索赔场景。license: Apache-2.0
version: 1.0.0
