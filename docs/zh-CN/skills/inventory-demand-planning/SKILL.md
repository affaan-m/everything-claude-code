...
description: 针对多地点零售商的需求预测、安全库存优化、补货计划和促销提升估算的编码化专业知识。由拥有15年以上管理数百个SKU经验的需求规划师提供。包括预测方法选择、ABC/XYZ分析、季节性过渡管理和供应商谈判框架。适用于需求预测、安全库存设定、补货计划、促销管理或库存水平优化。license: Apache-2.0
version: 1.0.0
