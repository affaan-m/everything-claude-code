...
description: 针对受监管制造业的质量控制、不符合项调查、根本原因分析、纠正措施和供应商质量管理的编码化专业知识。由在FDA、IATF 16949和AS9100环境中拥有15年以上经验的质量工程师提供。包括NCR生命周期管理、CAPA系统、SPC解释和审计方法。适用于调查不符合项、进行根本原因分析、管理CAPA、解释SPC数据或处理供应商质量问题。license: Apache-2.0
version: 1.0.0
