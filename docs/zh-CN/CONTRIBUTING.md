...
> **综合指南：** 有关创建有效技能的详细指导，请参阅[技能开发指南](../SKILL-DEVELOPMENT-GUIDE.md)。其中涵盖：
>
> * 技能架构与分类
> * 编写有效内容及示例
> * 最佳实践与常见模式
...
| 类别 | 目的 | 示例 |
|----------|---------|----------|
| **语言标准** | 习语、约定、最佳实践 | `python-patterns`、`golang-patterns` |
...
| **工具集成** | 工具/库的使用 | `docker-patterns`、`supabase-patterns` |
| **模板** | 项目特定技能模板 | `docs/examples/project-guidelines-template.md` |

### 技能适配政策

如果您正在从其他仓库、插件、框架或个人提示包移植想法，请在提交 PR 前阅读[技能适配政策](../skill-adaptation-policy.md)。
