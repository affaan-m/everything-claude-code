...
# 或仅为指定编程语言安装
./install.sh typescript    # 也可安装 python、golang、swift、php、arkts
# ./install.sh typescript python golang swift php arkts
...
# 或仅为指定编程语言安装
.\install.ps1 typescript   # 也可安装 python、golang、swift、php、arkts
# .\install.ps1 typescript python golang swift php arkts
...
> cp -r everything-claude-code/rules/arkts ~/.claude/rules/   # HarmonyOS/ArkTS 开发
>
> # 方案 B：项目级规则（仅对当前项目生效）
> mkdir -p .claude/rules
> cp -r everything-claude-code/rules/common .claude/rules/
